...
static struct sdl_video_s {
    ...
    */
    ...
    /* These are (1) the 320*200*8bpp paletted buffer that we copy the active buffer to,
       (2) the 320*200 intermediate buffer of the window/renderer's pixel format that
       we blit the former buffer to,
       (3) the intermediate 320*200 texture that we update with the intermediate's buffer data,
