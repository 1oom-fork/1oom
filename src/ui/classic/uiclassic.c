...
const struct cfg_items_s ui_cfg_items[] = {
    ...
    CFG_ITEM_BOOL("enable_bomb_animation", &game_battle_enable_bomb_animation),
...
const struct cmdline_options_s ui_cmdline_options[] = {
    ...
    { "-bombanimation", 0,
      options_enable_bool_var, (void *)&game_battle_enable_bomb_animation,
      NULL, "Enable bomb animation in space combat" },
    { "-nobombanimation", 0,
      options_disable_bool_var, (void *)&game_battle_enable_bomb_animation,
    ...
    { "-showroutes", 0,
      options_enable_bool_var, (void *)&ui_show_routes,
      NULL, "Enable show friendly routes" },
    { "-noshowroutes", 0,
