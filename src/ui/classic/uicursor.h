...
extern void ui_cursor_store_bg_back(int mx, int my);
extern void ui_cursor_store_bg_front(int mx, int my);
extern void ui_cursor_draw_back(int mx, int my);
extern void ui_cursor_draw_front(int mx, int my);
extern void ui_cursor_erase_front(void);
extern void ui_cursor_erase_back(void);
