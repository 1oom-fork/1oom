...
extern void ui_draw_box_fill(int x0, int y0, int x1, int y1, const uint8_t *colorptr, uint8_t color0, uint16_t colorhalf, uint16_t ac, uint8_t ae, int scale);
extern void ui_draw_hmm3(int x0, int y0, int x1, int y1, uint8_t color0, uint8_t color1, uint8_t ae, int scale);
