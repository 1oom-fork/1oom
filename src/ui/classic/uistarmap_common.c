...
static inline void ui_starmap_draw_starback(uint8_t *gfx, int x, int y)
{
    ...
    lbxgfx_draw_frame_offs(x + 320, y, gfx, UI_SCREEN_W);
    lbxgfx_draw_frame_offs(x, y + 200, gfx, UI_SCREEN_W);
    lbxgfx_draw_frame_offs(x + 320, y + 200, gfx, UI_SCREEN_W);
}
...
void ui_starmap_draw_starmap(struct starmap_data_s *d)
{
    ...
    ui_draw_filled_rect(UI_STARMAP_LIMITS, 0);
