...
void ui_draw_stars(int x, int y, int xoff1, int xoff2)
{
    ...
    int xo1, xo2;
    xo1 = (ui_data.gfx.draw_stars.xoff1 + xoff1) % (UI_SCREEN_W / 2);
    xo2 = (ui_data.gfx.draw_stars.xoff2 + xoff1 * 2) % (UI_SCREEN_W / 2);
...
void ui_draw_set_stars_xoffs(bool flag_right)
{
    ...
    ui_data.gfx.draw_stars.xoff1 = (ui_data.gfx.draw_stars.xoff1 + x1) % (UI_SCREEN_W / 2);
    ui_data.gfx.draw_stars.xoff2 = (ui_data.gfx.draw_stars.xoff2 + x2) % (UI_SCREEN_W / 2);
}
