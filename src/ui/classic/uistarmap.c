...
void ui_starmap_do(struct game_s *g, player_id_t active_player)
{
    ...
    int16_t oi_b, oi_c, oi_scroll, oi_starview1, oi_starview2, oi_shippic, oi_finished, oi_equals, oi_hash,
            ...
            oi_alt_galaxy, oi_alt_m, oi_alt_c, oi_alt_p, oi_alt_r, oi_alt_events, oi_wheelshippic
            ;
    ...
    while (!flag_done) {
        ...
        if (!flag_done) {
            ...
            if (1) {
                ...
                if (!ui_extra_enabled && (x0 >= 7) && (x1 <= 221) && (y0 >= 7) && (y1 <= 177) && BOOLVEC_IS1(p->explored, active_player)) {
