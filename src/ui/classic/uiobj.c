...
{
    uiobj_t *p;
    int i, x = mouse_get_x(), y = mouse_get_y();
    ui_cursor_update_gfx_i(x, y);
    uiobj_mouseoff = ui_cursor_mouseoff;
...
int16_t uiobj_add_mousearea_limited(int16_t x0, int16_t y0, int16_t x1, int16_t y1, mookey_t key, int16_t helpid)
{
    uiobj_t *p = &uiobj_tbl[uiobj_table_num];
...
int16_t uiobj_add_mousearea_all(mookey_t key, int16_t helpid)
{
