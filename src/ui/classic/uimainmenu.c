...
static struct main_menu_item_data_s mm_items[MAIN_MENU_ITEM_NUM] = {
    ...
    },
    {
        MAIN_MENU_ITEM_TYPE_PAGE,
        NULL, NULL,
        "Interface", NULL, MAIN_MENU_PAGE_INTERFACE,
        0, 0,
        MOO_KEY_1,
    },
    {
        MAIN_MENU_ITEM_TYPE_BOOL,
        NULL, NULL,
        "Combat Autoresolve", &ui_space_combat_autoresolve, 0,
        0, 0,
        MOO_KEY_c,
    },
    {
        MAIN_MENU_ITEM_TYPE_BOOL,
        NULL, NULL,
        "Modern Controls", &ui_modern_controls, 0,
        0, 0,
        MOO_KEY_m,
    },
    {
        MAIN_MENU_ITEM_TYPE_BOOL,
        NULL, NULL,
        "Bomb Animation", &game_opt_enable_bomb_animation, 0,
        0, 0,
        MOO_KEY_o,
    },
    {
