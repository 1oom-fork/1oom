...
static void design_init_ois(struct design_data_s *d)
{
    ...
    d->oi_name = uiobj_add_t4(214, 151, 56, d->gd->sd.name, SHIP_NAME_LEN - 1, 1, true, 0, colortbl_sd_hmm1, MOO_KEY_UNKNOWN);
...
static struct xy_s ui_design_draw_selbox(int xpos, int xoff1, int xoff2, int xoff3, int n, const char *str)
{
    ...
    ui_draw_hmm3(x0 + 4, y0 + 4, x0 + xpos + xoff2, y1 + 20, 1, 2, 0x37, ui_scale);
