...
/* Empire tech report technology text fix (ENVIRON). */
extern bool ui_fix_empirereport_environ;
...
/* Disable predefined mouse jump to Continue button. */
extern bool ui_qol_prebattle_no_setfocus;
...
extern void ui_enable_unofficial_1_3a(void);
