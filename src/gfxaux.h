...
extern void gfx_aux_draw_frame_from_limit(int x, int y, struct gfx_aux_s *aux, uint16_t pitch);
extern void gfx_aux_draw_frame_from_rotate_limit(int x0, int y0, int x1, int y1, struct gfx_aux_s *aux, uint16_t pitch);
