...
extern size_t util_file_try_load_len(const char *name, uint8_t *buf, size_t wantlen);
extern int util_file_save(const char *name, const uint8_t *src, size_t size);
