...
extern void lbxgfx_draw_frame(int x, int y, uint8_t *data);
extern void lbxgfx_draw_frame_pal(int x, int y, uint8_t *data);
extern void lbxgfx_draw_frame_offs(int x, int y, uint8_t *data);
...
extern void lbxgfx_apply_colortable(int x0, int y0, int x1, int y1, uint8_t ctbli);
