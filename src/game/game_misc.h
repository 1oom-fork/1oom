...
extern int game_get_min_dist(struct game_s *g, int player_i, int planet_i);
extern int game_adjust_prod_by_special(int prod, planet_special_t special);
extern int game_get_pop_growth_max(struct game_s *g, int planet_i, int max_pop3);
extern int game_get_pop_growth_for_eco(struct game_s *g, int planet_i, int eco);
extern int game_get_tech_prod(int prod, int slider, race_t race, planet_special_t special);
extern void game_print_prod_of_total(const struct game_s *g, int prod, char *buf);
