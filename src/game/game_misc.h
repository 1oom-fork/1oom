...
extern int game_get_min_dist(const struct game_s *g, player_id_t player_i, planet_id_t planet_i);
extern int game_get_pop_growth_max(const struct game_s *g, planet_id_t planet_i, int max_pop3);
extern int game_get_pop_growth_for_eco(const struct game_s *g, planet_id_t planet_i, int eco);
