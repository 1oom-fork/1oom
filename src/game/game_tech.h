...
extern uint8_t game_tech_player_has_tech(const struct game_s *g, int field_i, int tech_i, player_id_t player_i);
extern uint8_t game_tech_player_best_tech(const struct game_s *g, int field_i, int tech_i_base, int tech_i_step, int tech_i_max, player_id_t player_i);
