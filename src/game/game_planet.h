...
extern void game_planet_adjust_max(struct game_s *g, uint8_t planet_i, planet_slider_i_t si);
extern void game_planet_adjust_perc(struct game_s *g, uint8_t planet_i, planet_slider_i_t si, uint8_t percent);
