...
typedef enum {
    ...
    GOVERNOR_ECO_MODE_MASK = 7,
    GOVERNOR_BUILDUP_MIL = 8,
    GOVERNOR_BUILDUP_FULL = 16,
    GOVERNOR_ECO_MODE_AUTO_TECH = 64
} governor_eco_mode_t;

typedef enum {
    XOPTION_EVENTS_ALL = 0,
    XOPTION_EVENTS_NONE = 1,
    XOPTION_EVENTS_LATE = 2,
    XOPTION_EVENTS_GOOD = 3,
    XOPTION_EVENTS_MASK = 3,
    XOPTION_EVENTS_NUM = 4,

    XOPTION_COUNCIL_2_3 = 0,
    XOPTION_COUNCIL_3_4 = 4,
    XOPTION_COUNCIL_ORION = 8,
    XOPTION_COUNCIL_OFF = 12,
    XOPTION_COUNCIL_MASK = 12,
    XOPTION_COUNCIL_NUM = 4,

    XOPTION_GUARDIAN_WEAK = 16,
    XOPTION_GUARDIAN_NUM = 2,

    XOPTION_RULES_FIX = 32,
    XOPTION_RULES_V13 = 64,
    XOPTION_RULES_MASK = 96,
    XOPTION_RULES_NUM = 3
} xoption_t;
