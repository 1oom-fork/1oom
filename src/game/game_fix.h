...
/* The tech tree generation routine now checks for presence of
at least one planetary shields tech for every race. */
extern bool game_fix_shield_tech;
...
extern void game_enable_unofficial_1_3a(void);
