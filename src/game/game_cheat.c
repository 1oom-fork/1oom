...
bool game_cheat_tech_hint(struct game_s *g, player_id_t pi)
{
    g->gaux->flag_cheat_tech_hint = !g->gaux->flag_cheat_tech_hint;
    return true;
}

bool game_cheat_distance_hint(struct game_s *g, player_id_t pi)
{
    g->gaux->flag_cheat_distance_hint = !g->gaux->flag_cheat_distance_hint;
    return true;
}
