...
extern int game_spy_select_random_techs(struct game_s *g, struct spy_esp_s *s);
extern int game_spy_select_useful_techs(struct game_s *g, struct spy_esp_s *s, int minval, int itop);
extern int game_spy_sift_useful_techs(struct game_s *g, struct spy_esp_s *s, int itop);
