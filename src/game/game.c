...
static int game_opt_game_mode_extra = 0;
...
static void game_save_custom_opts_to_cfg(struct game_new_options_s *go)
{
    ...
    game_opt_game_mode_extra = go->no_elections;
...
const struct cmdline_options_s main_cmdline_options[] = {
    ...
    { "-bombainmation", 0,
      options_enable_bool_var, (void *)&game_opt_enable_bomb_animation,
      NULL, "Enable bomb animation" },
    { "-nobombanimation", 0,
      options_disable_bool_var, (void *)&game_opt_enable_bomb_animation,
      NULL, "Disable bomb animation" },
    { "-nextturn", 0,
...
const struct cfg_items_s game_cfg_items[] = {
    ...
    CFG_ITEM_BOOL("bombanimation", &game_opt_enable_bomb_animation),
