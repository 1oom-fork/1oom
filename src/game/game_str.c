...
const char *game_str_tbl_diffic[DIFFICULTY_NUM] = { "Simple", "Easy", "Average", "Hard", "Impossible", "Hopeless" };
...
const char *game_str_ng_elections = "Elections";
const char *game_str_ng_space_combat = "Space combat";
...
const char *game_str_sm_sh_everywhere = "Build everywhere";
const char *game_str_sm_sh_replace = "Replace";
...
const char *game_str_gv_enabled = "Governor enabled";
const char *game_str_gv_disabled = "Governor disabled";
