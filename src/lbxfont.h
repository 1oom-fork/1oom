...
extern uint16_t lbxfont_plotchar(char c, uint8_t *buf);

extern int lbxfont_print_str_normal(int x, int y, const char *str);
extern int lbxfont_print_str_center(int x, int y, const char *str);
extern int lbxfont_print_str_right(int x, int y, const char *str);
extern void lbxfont_print_str_split(int x, int y, int maxw, const char *str, int type);
extern int lbxfont_print_str_normal_limit(int x, int y, const char *str);
extern int lbxfont_print_str_center_limit(int x, int y, const char *str);
extern int lbxfont_print_str_center_limit_unconst(int x, int y, const char *str);
extern int lbxfont_print_num_normal(int x, int y, int num);
extern int lbxfont_print_num_center(int x, int y, int num);
extern int lbxfont_print_num_right(int x, int y, int num);
extern int lbxfont_print_range_right(int x, int y, int num0, int num1);
