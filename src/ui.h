...
extern void ui_battle_init(struct battle_s *bt);
extern void ui_battle_shutdown(struct battle_s *bt, bool colony_destroyed);

extern void ui_battle_draw_misshield(const struct battle_s *bt, battle_item_id_t target_i, int target_x, int target_y, int missile_i);
extern void ui_battle_draw_damage(const struct battle_s *bt, battle_item_id_t target_i, int target_x, int target_y, uint32_t damage);
...
extern void ui_battle_draw_arena(const struct battle_s *bt, battle_item_id_t itemi, int dmode);
extern void ui_battle_draw_item(const struct battle_s *bt, battle_item_id_t itemi, int x, int y);
extern void ui_battle_draw_bomb_attack(const struct battle_s *bt, battle_item_id_t attacker_i, battle_item_id_t target_i, ui_battle_bomb_t bombtype);
extern void ui_battle_draw_beam_attack(const struct battle_s *bt, battle_item_id_t attacker_i, battle_item_id_t target_i, int wpni);
extern void ui_battle_draw_stasis(const struct battle_s *bt, battle_item_id_t attacker_i, battle_item_id_t target_i);
extern void ui_battle_draw_pulsar(const struct battle_s *bt, battle_item_id_t attacker_i, int ptype, const uint32_t *dmgtbl);
extern void ui_battle_draw_stream1(const struct battle_s *bt, battle_item_id_t attacker_i, battle_item_id_t target_i);
extern void ui_battle_draw_stream2(const struct battle_s *bt, battle_item_id_t attacker_i, battle_item_id_t target_i);
extern void ui_battle_draw_blackhole(const struct battle_s *bt, battle_item_id_t attacker_i, battle_item_id_t target_i);
extern void ui_battle_draw_technull(const struct battle_s *bt, battle_item_id_t attacker_i, battle_item_id_t target_i);
extern void ui_battle_draw_repulse(const struct battle_s *bt, battle_item_id_t attacker_i, battle_item_id_t target_i, int sx, int sy);
...
extern ui_sabotage_t ui_spy_sabotage_ask(struct game_s *g, player_id_t spy, player_id_t target, planet_id_t *planetptr);
extern player_id_t ui_spy_sabotage_done(struct game_s *g, player_id_t pi, player_id_t spy, player_id_t target, ui_sabotage_t act, player_id_t other1, player_id_t other2, planet_id_t planet, int snum);

extern void ui_newtech(struct game_s *g, player_id_t pi);

extern bool ui_explore(struct game_s *g, player_id_t pi, planet_id_t planet_i, bool by_scanner, bool flag_colony_ship);
extern void ui_landing(struct game_s *g, player_id_t pi, planet_id_t planet_i);

extern bool ui_bomb_ask(struct game_s *g, player_id_t pi, planet_id_t planet_i, int pop_inbound);
extern void ui_bomb_show(struct game_s *g, player_id_t attacker_i, player_id_t owner_i, planet_id_t planet_i, int popdmg, int factdmg, bool play_music);
